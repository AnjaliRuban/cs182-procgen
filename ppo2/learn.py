...
def learn(*, network, env, total_timesteps, eval_env = None,
          ...
          init_fn=None,
          data_aug='normal', args=None, **network_kwargs):
    '''
    ...
    **network_kwargs:                 keyword arguments to the policy / network builder. See baselines.common/policies.py/build_policy and arguments to a particular type of network
    ...
    policy = build_policy(args, env, network, data_aug=data_aug, **network_kwargs)
    ...
    model = model_fn(policy=policy, ob_space=ob_space, ac_space=ac_space,
                    ...
                    max_grad_norm=max_grad_norm, args=args)
    ...
    logger.info('Number of timesteps: ' + str(total_timesteps))
    logger.info('Number of batches: ' + str(nbatch))
    logger.info('Number of updates: ' + str(nupdates))
